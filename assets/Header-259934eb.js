import{s as t,c as n,N as w,j as e,u as L,r as c,a6 as _,k as x,m,a7 as q,A as R,a8 as J,a9 as K}from"./index-2c5cedcc.js";import{c as Q,a as X,u as Y}from"./index.esm-5a7ecbcb.js";const ee=t(w)`
  display: inline-flex;
  align-items: center;
`,ie=t.svg`
  width: 22px;
...
`,be=()=>e.jsxs(ge,{children:[e.jsx(me,{children:"©2023 Drink Master. All rights reserved."}),e.jsxs(ue,{children:[e.jsx(T,{to:"/privacy",children:"Privacy Policy"}),e.jsx(T,{to:"/service",children:"Terms of Service"})]})]}),ii=t.div`
  min-height: 100hv;
  margin: 0 auto;
  padding-right: 20px;
  padding-left: 20px;
...
`,oi=()=>e.jsx(we,{children:e.jsxs(fe,{children:[e.jsxs(je,{children:[e.jsxs(ke,{children:[e.jsxs(ve,{children:[e.jsx(V,{theme:"dark"}),e.jsx(se,{theme:"dark"})]}),e.jsx(oe,{})]}),e.jsx(he,{})]}),e.jsx(be,{}),e.jsx(ye,{}),e.jsx(Ce,{})]})}),$e=t.nav`
display: inline-flex;
flex-direction: column;
align-items: center;
gap: 16px;
...
`,Se=()=>{const i=x(m);return e.jsxs($e,{children:[e.jsx(p,{to:"/home",theme:i,children:"Home"}),e.jsx(p,{to:"/drinks",theme:i,children:"Drinks"}),e.jsx(p,{to:"/add",theme:i,children:"Add drink"}),e.jsx(p,{to:"/my",theme:i,children:"My drinks"}),e.jsx(p,{to:"/favorites",theme:i,children:"Favorites"})]})},Le=t.div`
  position: relative;
  width: 40px;
  height: 20px;
  border-radius: 10px;
...
`,M=()=>{const i=x(m),o=L();return e.jsx(Le,{theme:i,children:e.jsx(Fe,{onClick:()=>o(q()),theme:i})})},ze=t.div`
  position: relative;
  z-index: 100;
`,De=t.div`
  display: flex;
...
`,Ee=t.div`
  ...
  top: 0;
  left: 10%;
`,Te=t.svg`${({theme:i})=>i==="dark"?` stroke: ${n.light};`:`stroke: ${n.primaryDark};`}`,g="/fs-80-react-node-DanyloTytarenko/assets/sprite-062e31f9.svg",Me=({isOpen:i,toggleMenu:o})=>{const r=x(m);return e.jsxs(ze,{children:[i===!1?e.jsxs(De,{onClick:o,children:[e.jsx(b,{theme:r}),e.jsx(b,{theme:r}),e.jsx(b,{theme:r}),e.jsx(b,{theme:r})]}):e.jsx(Te,{width:"24px",height:"24px",theme:r,onClick:o,children:e.jsx("use",{href:`${g}#icon-close`})}),e.jsxs(Be,{open:i,theme:r,children:[e.jsx(Ee,{}),e.jsx(p,{to:"/home",onClick:o,children:"Home"}),e.jsx(p,{to:"/drinks",onClick:o,children:"Drinks"}),e.jsx(p,{to:"/add",onClick:o,children:"Add drink"}),e.jsx(p,{to:"/my",onClick:o,children:"My drinks"}),e.jsx(p,{to:"/favorites",onClick:o,children:"Favorites"})]})]})},Ie=t.header`
  display: flex;
  align-items: center;
...
`,f="/fs-80-react-node-DanyloTytarenko/assets/user-833bcaa2.jpg",Ve=()=>{const i=x(m),o=x(R);return e.jsxs(He,{children:[e.jsx(We,{children:e.jsx("img",{width:"44",height:"44",src:o.avatar||f,alt:"User avatar",onError:r=>{r.currentTarget.src=f}})}),e.jsx(Re,{theme:i,children:o.name})]})},Ne=t.div`
